  ...
  return (
    <>
      <div className="w-full min-h-screen items-center grid grid-rows-1 grid-cols-1 lg:grid-cols-[10%_40%_50%] px-10">
        <div className="w-[200px] flex flex-col gap-10 text-3xl justify-center items-center">
        ...
        <div className="xl:w-100 xl:w-3/4 md:text-left text-center">
          <h2 className="md:text-5xl text-4xl font-bold text-main lg:pt-0 pt-5">
            {profile.name}
          </h2>
          <h3 className="typed flex md:justify-start justify-center text-2xl gap-2 font-normal text-second md:text-4xl pt-2">
            I'm a
            <TypeAnimation
              sequence={[
                "Web Developer",
